...
$dashboardProcess = Start-Process powershell.exe -ArgumentList @('-NoProfile','-ExecutionPolicy','Bypass','-Command',"& '$PSScriptRoot\windrose\4129620\windrose_plus\server\windrose_plus_server.ps1' -Port '$($args[0])' -GameDir '$PSScriptRoot\windrose\4129620'") -PassThru
